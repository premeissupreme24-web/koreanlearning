const CACHE_VERSION = "korean-learning-pwa-v11";
...
const CORE_ASSETS = [
  ...
  "./css/styles.css?v=11",
  "./data/letters.js?v=11",
  "./data/pronunciationRules.js?v=11",
  "./data/quizItems.js?v=11",
  "./data/vocabulary.js?v=11",
  "./data/dialogues.js?v=11",
  "./js/i18n.js?v=11",
  "./js/audio.js?v=11",
  "./js/progress.js?v=11",
  "./js/canvas.js?v=11",
  "./js/quizEngine.js?v=11",
  "./js/copybook.js?v=11",
  "./js/app.js?v=11",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
